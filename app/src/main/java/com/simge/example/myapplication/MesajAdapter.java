...
public class MesajAdapter extends RecyclerView.Adapter<MesajAdapter.ViewHolder> { //Adapter list'lerin view'lenmesi için kullanılır.

     Context context;          //Adapter genelde list ve context parametlerini alır.
