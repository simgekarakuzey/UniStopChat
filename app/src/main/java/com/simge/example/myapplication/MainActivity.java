...
public class MainActivity extends AppCompatActivity {
    ...
    public void tanimla()
    {
        ...
        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(MainActivity.this,2); //Bir satırda iki kayıt göster.
    ...
    public void listele()
    {
        reference.child("Kullanıcılar").addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                if(!dataSnapshot.getKey().equals(userName)){ //kullanıcının kendi adının listelenmemesi için
